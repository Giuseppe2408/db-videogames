...
--SELECT pegi_label_id, COUNT(pegi_label_id)
...
--SELECT videogames.name, videogames.id, categories.id, categories.name
--FROM categories
--INNER JOIN category_videogame ON categories.id = category_id
